...
var sh = {
    ...
    regexLib : {
        ...
        routeScriptTags             : { left: /(&lt;|<)\s*script.*?(&gt;|>)/gi, right: /(&lt;|<)\/\s*script\s*(&gt;|>)/gi },
        ctrlScriptTags              : { left: /(&lt;|<)\s*script.*?(&gt;|>)/gi, right: /(&lt;|<)\/\s*script\s*(&gt;|>)/gi },
        modelScriptTags             : { left: /(&lt;|<)\s*script.*?(&gt;|>)/gi, right: /(&lt;|<)\/\s*script\s*(&gt;|>)/gi }
    },
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.forHtmlScript(r.routeScriptTags);
        this.langLabel = "route";
    };

    Brush.prototype = new SyntaxHighlighter.Highlighter();
    Brush.aliases   = ['route'];

    SyntaxHighlighter.brushes.route = Brush;
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.forHtmlScript(r.ctrlScriptTags);
        this.langLabel = "controller";
    };

    Brush.prototype = new SyntaxHighlighter.Highlighter();
    Brush.aliases   = ['controller', 'ctrl'];

    SyntaxHighlighter.brushes.controller = Brush;
...
;(function()
{
    ...
    function Brush()
    {
        ...
        this.forHtmlScript(r.modelScriptTags);
        this.langLabel = "model";
    };

    Brush.prototype = new SyntaxHighlighter.Highlighter();
    Brush.aliases   = ['model'];

    SyntaxHighlighter.brushes.model = Brush;
