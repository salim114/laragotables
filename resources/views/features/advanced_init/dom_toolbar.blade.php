	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				<p>For more complex features, or for creating reusable plug_ins, DataTables also has a feature plug-in API available, which can be used to create plug_ins which
