	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				"//datatables.net/reference/option/search.return"><code class="option" title="DataTables initialisation option">search.return</code></a> parameter as shown in this
				example.</p>
			</div>
			<div class="demo-html">
