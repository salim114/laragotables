...
<head>
	...
	<title>DataTables features - Server-side processing</title>
</head>
	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				<p>The features in this section show server-side processing in use and how it can be customised to suit your needs.</p>
			</div>
		</section>
	</div>
	<section>
		<div class="footer">
			...
			<div class="liner">
				<div class="toc">
					<div class="toc-group">
						<h3><a href="{{ url('features') }}">Server-side</a></h3>
						<ul class="toc">
							<li>
