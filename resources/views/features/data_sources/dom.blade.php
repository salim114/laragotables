...
<head>
	...
	<title>DataTables feature - HTML (DOM) sourced data</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>HTML (DOM) sourced data</span></h1>
			<div class="info">
				...
				<p>For further and more complex features of using DataTables with DOM sourced data, please refer to the <a href="{{ url('features/basic_init/index') }}">basic initialisation</a> and
				<a href="{{ url('features/advanced_init/index') }}">advanced initialisation</a> features.</p>
			</div>
			<div class="demo-html">
