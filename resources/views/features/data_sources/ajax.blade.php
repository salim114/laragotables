...
<head>
	...
	<title>DataTables feature - Ajax sourced data</title>
	<!-- Styles -->
	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				"DataTables initialisation option">ajax</code></a> documentation and the <a href="{{ url('features/ajax/index') }}">other Ajax features</a> for further information.</p>
