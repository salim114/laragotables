...
<head>
	...
	<script type="text/javascript" language="javascript" src="{{ asset('js/dataTables.uikit.js') }}"></script>
			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.uikit.js') }}">public/js/dataTables.uikit.js</a>
						</li>
					</ul>
				</div>
				<div class="table">
				...
				<div class="css">
					...
					<ul>
						<li>
							<a href="https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.2/css/uikit.min.css">https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.2/css/uikit.min.css</a>
						</li>
						<li>
							<a href="{{ asset('css/dataTables.uikit.css') }}">public/css/dataTables.uikit.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.uikit');       
					    }</code>
