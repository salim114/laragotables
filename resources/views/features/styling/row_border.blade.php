...
<head>
	...
	<title>DataTables feature - Base style - row borders</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>Base style - row borders</span></h1>
			<div class="info">
				<p>This example shows DataTables with just the <code>row_border</code> class specified, which can create a pleasing, minimalist, interface for your tables.</p>
			</div>
			<div class="demo-html">
			...
			<div class="tabs">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.row_border');       
					    }</code>
