...
<head>
	...
	<title>DataTables feature - Base style</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>Base style</span></h1>
			<div class="info">
				...
				<ul class="markdown">
					<li><code>cell_border</code> - Cells with a border</li>
					...
					<li><code>order_column</code> - Highlight the cells in the column currently being ordering upon</li>
					<li><code>row_border</code> - Rows with a border</li>
				...
				<p>The <code>display</code> class is a short-cut for specifying the <code>stripe hover order_column row_border</code> as the class name for a table. This is shown
			...
			<div class="tabs">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.display');       
					    }</code>
