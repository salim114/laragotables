...
<head>
	...
	<script type="text/javascript" language="javascript" src="{{ asset('js/dataTables.bootstrap5.js') }}"></script>
			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.bootstrap5.js') }}">public/js/dataTables.bootstrap5.js</a>
						</li>
					</ul>
				</div>
				<div class="table">
				...
				<div class="css">
					...
					<ul>
						<li>
							<a href=
							"https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.0.1/css/bootstrap.min.css">https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.0.1/css/bootstrap.min.css</a>
						</li>
						<li>
							<a href="{{ url('css/dataTables.bootstrap5.css') }}">public/css/dataTables.bootstrap5.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.bootstrap5');       
					    }</code>
