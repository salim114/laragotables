...
<head>
	...
	<script type="text/javascript" language="javascript" src="{{ asset('js/dataTables.jqueryui.js') }}"></script>
			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.jqueryui.js') }}">public/js/dataTables.jqueryui.js</a>
						</li>
					</ul>
				</div>
				<div class="table">
				...
				<div class="css">
					...
					<ul>
						...
						<li>
							<a href="{{ url('css/dataTables.jqueryui.css') }}">public/css/dataTables.jqueryui.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.jqueryUI');       
					    }</code>
