...
<head>
	...
	<title>DataTables feature - Base style - no styling classes</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>Base style - no styling classes</span></h1>
			<div class="info">
			...
			<div class="tabs">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.no_classes');       
					    }</code>
