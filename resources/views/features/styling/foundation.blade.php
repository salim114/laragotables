			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.foundation.js') }}">public/js/dataTables.foundation.js</a>
						</li>
					</ul>
				</div>
				<div class="table">
				...
				<div class="css">
					...
					<ul>
						...
						<li>
							<a href="{{ url('css/dataTables.foundation.css') }}">public/css/dataTables.foundation.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.foundation');       
					    }</code>
