...
<head>
	...
	<script type="text/javascript" language="javascript" src="{{ asset('js/dataTables.bulma.js') }}"></script>
			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.bulma.js') }}">public/js/dataTables.bulma.js</a>
						</li>
					</ul>
				</div>
				<div class="table">
				...
				<div class="css">
					...
					<ul>
						<li>
							<a href="https://cdnjs.cloudflare.com/ajax/libs/bulma/0.9.3/css/bulma.min.css">https://cdnjs.cloudflare.com/ajax/libs/bulma/0.9.3/css/bulma.min.css</a>
						</li>
						<li>
							<a href="{{ url('css/dataTables.bulma.css') }}">public/css/dataTables.bulma.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
				...
				<div id="controller" class="ctrl">
					...
					<code class="multiline language-ctrl">
					    ...
					    {
					        return view('features.styling.bulma');       
					    }</code>
