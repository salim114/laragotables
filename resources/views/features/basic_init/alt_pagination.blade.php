...
<head>
	...
	<title>DataTables feature - Alternative pagination</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>Alternative pagination</span></h1>
			<div class="info">
				...
				<p>Additional options for the buttons that are shown can be added through the use of pagination type plug_ins. Furthermore, how the buttons are actually shown can
