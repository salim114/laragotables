...
<head>
	...
	<title>DataTables feature - Scroll - horizontal</title>
	<!-- Styles -->
...
<body class="dt-example">
	<div class="container">
		<section>
			<h1>DataTables feature <span>Scroll - horizontal</span></h1>
			<div class="info">
				...
				"DataTables initialisation option">scrollX</code></a> parameter to be <code>true</code>.</p>
