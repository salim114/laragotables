			...
			<div class="tabs">
				<div class="js">
					...
					<ul>
						...
						<li>
							<a href="{{ url('js/dataTables.searchPanes.js') }}">public/js/dataTables.searchPanes.js</a>
						</li>
						<li>
							<a href="{{ url('js/dataTables.select.js') }}">public/js/dataTables.select.js</a>
						</li>
						<li>
				...
				<div class="css">
					...
					<ul>
						...
						<li>
							<a href="{{ url('css/searchPanes.dataTables.css') }}">public/css/searchPanes.dataTables.css</a>
						</li>
						<li>
							<a href="{{ url('css/select.dataTables.css') }}">public/css/select.dataTables.css</a>
						</li>
					</ul>
				</div>
				<div class="ajax">
