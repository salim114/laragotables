...
<head>
	...
	<title>DataTables extensions - initialisation </title>
</head>
<body class="dt-example">
	<div class="container">
		<section>
			...
			<div class="info">
				<p>Spreadsheets such as Excel and Google Docs have a very handy data duplication option of an auto fill tool. The AutoFill library for DataTables provides a similar interface for DataTables (even extending upon it to provide complex data interaction options). AutoFill also provides full support for Editor allowing end users to update data very quickly.</p>
			</div>
		</section>
	</div>
	<section>
		<div class="footer">
			...
			<div class="liner">
				<div class="toc">
					<div class="toc-group">
						<h3><a href="{{ url('extensions') }}"><i class="fa fa-arrow-circle-right"></i> AutoFill</a></h3>
						<h3 class="tx"><a href="{{ url('extensions/autofill') }}">Initialisation</a></h3>
		                <ul class="toc active">
		                    <li>
