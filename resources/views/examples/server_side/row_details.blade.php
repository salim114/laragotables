	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				<p>Furthermore, this example shows a small difference from the <a href="{{ url('examples/api/row_details') }}">client-side row details example</a> in that to have rows
