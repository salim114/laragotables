	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				<p>For further and more complex examples of using DataTables with DOM sourced data, please refer to the <a href="{{ url('examples/basic_init/index') }}">basic initialisation</a> and
				<a href="{{ url('examples/advanced_init/index') }}">advanced initialisation</a> examples.</p>
			</div>
			<div class="demo-html">
