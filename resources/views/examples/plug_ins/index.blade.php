...
<head>
	...
	<title>DataTables examples - plug_ins</title>
</head>
	...
	<div class="container">
		<section>
			...
			<div class="info">
				...
				plug_ins.</p>
				<p>The examples in this section show how plug_ins can be used and developed for DataTables.</p>
			</div>
		</section>
	</div>
	<section>
		<div class="footer">
			...
			<div class="liner">
				<div class="toc">
					<div class="toc-group">
						<h3><a href="{{ url('examples') }}">plug_ins</a></h3>
						<ul class="toc">
							<li>
