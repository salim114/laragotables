...
<body class="dt-example">
	<div class="container">
			...
			<div class="info">
				...
				"DataTables initialisation option">columns.data</code></a> is used with <a href="{{ url('examples/ajax/objects') }}">Ajax sourced data</a> to tell DataTables where to read data
