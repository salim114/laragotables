<div class="footer">
    ...
    <div class="liner">
        ...
        <div class="toc">
            <div class="toc-group">
                <h3><a href="{{ url('examples') }}">Basic initialisation</a></h3>
                <ul class="toc active">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/advanced_init/index') }}">Advanced initialisation</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/non_jquery/index') }}">Non-jQuery initialisation</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/styling/index') }}">Styling</a></h3>
                <ul class="toc">
                    ...
                    <li class="{{ Str::endsWith(request()->url(), 'styling/order_column') ? 'active' : '' }}">
                        <a href="{{ url('examples/styling/order_column') }}">Base style - order-column</a>
                    </li>
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/data_sources/index') }}">Data sources</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/api/index') }}">API</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/ajax/index') }}">Ajax</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/server_side/index') }}">Server-side</a></h3>
                <ul class="toc">
            ...
            <div class="toc-group">
                <h3><a href="{{ url('examples/plug_ins/index') }}">plug_ins</a></h3>
                <ul class="toc">
